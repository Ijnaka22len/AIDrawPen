...
{
  0x99, 0xec, 0x0d, 0xe9, 0xc5, 0xf8, 0x80, 0xa5, 0x23, 0x49, 0x19, 0x15, 0x33, 0x31, 0x49, 0xc6, 
  0x06, 0xd5, 0xcf, 0x68, 0x24, 0xb6, 0x6d, 0xa1, 0x77, 0x41, 0x69, 0x06, 0xe5, 0x63, 0xe1, 0x41, 
  0x92, 0xa9, 0x21, 0x08, 0xc0, 0x65, 0x68, 0xba, 0xc9, 0x47, 0x82, 0x7f, 0xd4, 0x6f, 0xc8, 0xc4, 
  0xf9, 0x90, 0xbd, 0x9d, 0xa2, 0x1f, 0x3b, 0x95, 0x9b, 0x4f, 0x51, 0xe8, 0xe2, 0x71, 0x45, 0x57, 
  0x0c, 0x58, 0x2f, 0x16, 0x2e, 0xb0, 0xa7, 0x9e, 0x89, 0x44, 0xea, 0xd3, 0xba, 0x95, 0x00, 0x9c, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_15) = {
  .len = 29,
  .data = { 0x41, 0x49, 0x44, 0x72, 0x61, 0x77, 0x50, 0x65, 0x6e, 0x20, 0x43, 0x6c, 0x61, 0x72, 0x6b, 0x73, 0x6f, 0x6e, 0x20, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x69, 0x74, 0x79, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  ...
  .max_len = 9,
  .len = 9,
  .data = { 0x41, 0x49, 0x44, 0x72, 0x61, 0x77, 0x50, 0x65, 0x6e, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x13, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x8000 } },
  { .handle = 0x14, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_19 },
  { .handle = 0x15, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x8001 } },
  { .handle = 0x16, .uuid = 0x8001, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_21 },
  { .handle = 0x17, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x8002 } },
  { .handle = 0x18, .uuid = 0x8002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_23 },
  { .handle = 0x19, .uuid = 0x0000, .permissions = 0x8801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_24 },
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8003 } },
  { .handle = 0x1b, .uuid = 0x8003, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_26 },
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8004 } },
  { .handle = 0x1e, .uuid = 0x8004, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_29 },
  ...
  { .handle = 0x22, .uuid = 0x0007, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x23, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_34 },
  { .handle = 0x24, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8005 } },
  { .handle = 0x25, .uuid = 0x8005, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
